          ...
          with tf.Session(graph=detection_graph) as sess:
            ...
            while(cap.isOpened()):
                ...
                counter, csv_line, the_result = vis_util.visualize_boxes_and_labels_on_image_array(cap.get(1),
                                                                                                      ...
                                                                                                      line_thickness=4)
                if(len(the_result) == 0):
                    cv2.putText(input_frame, "...", (500, 35), font, 0.8, (0,255,255),2,cv2.FONT_HERSHEY_SIMPLEX)                       
                else:
                    cv2.putText(input_frame, the_result, (500, 35), font, 0.8, (0,255,255),2,cv2.FONT_HERSHEY_SIMPLEX)
